...
#----------------------------------------------------------------------------------------- 
# This function, dn(E,Q,Z,forb) Calculates the branch  antineutrino kinetic energy 
# spectrum. It takes the following variables: Q, the branch endpoint; Z, the number of 
# protons in the daughter nucleus; forb, the forbiddenness. E the energy of the neutrino.
#-----------------------------------------------------------------------------------------
def dn(E,Q,Z,A,forb):
...
def read_ENSDF(infile):
	...
	for line in infile:
		if line[0:80].isspace(): # if we reach end of file, calculate and plot spectrum
			...
			#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			# Neutrino energy spectrum data output
			#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Execute main program. First choose input ENSDF file as infile. 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

infile = open('ENSDF_beta/16N','r')
read_ENSDF(infile)
